            ...
            <div class="w-full hidden" id="dashboard-interface">
                <div class="w-full flex mt-4">
                    ...
                    <div>
                        ...
                        <button class="bg-red-500 px-2 py-1 rounded-md text-white" id='logout'>Logout</button>
                    </div>
                </div>
        ...
        <script>
            ...
            $(document).on('click', '.viewAppoint', function(e) {
                ...
                if(type == 'user') {
                                ...
                                <div class='text-left my-auto text-[.75em] w-full'>
                                    ...
                                    <form class='w-full mt-2 gap-2 flex flex-col submitReview' id='${data[i].AppoinmentID}'>
                                        ...
                                        <div class='flex w-full gap-2'>
                                            <button class='bg-red-500 px-2 py-1 w-full text-white rounded-md mt-2 cancelAppoint' id='${data[i].AppoinmentID}' type='button'>Cancel</button>
                                            ...
                                            <button class='bg-red-600 px-2 py-1 w-full text-white rounded-md mt-2 ${!hasReviews ? 'hidden' : ''} deleteReviews' id='${data[i].AppoinmentID}' type='button'>Delete Review</button>
                                        </div>
                                    </form>
                                </div>
                            </div>`;
                    ...
                    .then((data) => {
                        let appoint = "";
                        for(var i = 0; i < data.length; i++) {
                            // Check if reviews and ratings exist for this appointment
                            const hasReviews = data[i].Ratings != null && data[i].Reviews != null;
            ...
            $(document).on('click', '.selecthospital', function(e) {
                ...
                .then((data) => {
                    ...
                    // $('#select_TotalReviews').text(data.TotalReviews+" Reviews");
                    } else {
